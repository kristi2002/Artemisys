        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                <h6 class="fw-semibold mb-3" style="color:#0c1a3a;">
                    <i class="fas fa-plus-circle me-2" style="color:#1e40af;"></i>Aggiungi materia
                </h6>
                <?php if (empty($materieDisponibili)): ?>
                    <p class="text-muted small">
                        <?= empty($materieAssegnate)
                            ...
                            : 'Tutte le materie sono già state assegnate a questo anno.' ?>
                    </p>
                <?php else: ?>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white border-bottom py-3 px-4 d-flex align-items-center justify-content-between">
                ...
                <span class="badge" style="background:#e8eef8;color:#1e40af;">
                    <?= count($materieAssegnate) ?> <?= count($materieAssegnate) === 1 ? 'materia' : 'materie' ?>
                </span>
            </div>
            <div class="card-body p-0">
                <?php if (empty($materieAssegnate)): ?>
                    <div class="empty-state">
                        ...
                        <p>Aggiungi le materie di questo anno dal pannello.</p>
                    </div>
                <?php else: ?>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white border-bottom py-3 px-4 d-flex align-items-center justify-content-between">
                ...
                <div class="d-flex align-items-center gap-2">
                    <span class="badge" style="background:#e8eef8;color:#1e40af;">
                        <?= count($studenti) ?> <?= count($studenti) === 1 ? 'studente' : 'studenti' ?>
                    </span>
                    <a href="<?= BASE_URL ?>percorsi/scarica-scrutinio?anno_id=<?= $anno['id'] ?>"
                       class="btn btn-sm btn-outline-primary">
                        <i class="fas fa-download me-1"></i>Scrutinio studenti iscritti
                    </a>
                </div>
            </div>
            <div class="card-body p-0">
